...
* date:             2011-7-17:11:22:29
*
* Description:      ��ȡ��Ļoutput type tvformat
*
* parameters:       
*
* return:           if success return GUI_RET_OK
...
*
* Description:      ��FB numΪfb_id��bufno��ʾ���� 
*
* parameters:       
*
* return:           if success return GUI_RET_OK
...
*
* Description:      �ͷ�fb id��framebuffer��������Դ 
*
* parameters:       
*
* return:           if success return GUI_RET_OK
